...
async def play_now_handler(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    await callback_query.message.edit_text("Супер! Вот правила:\n\n"
                                         ...
                                         "3. У тебя будет 1 попытка, чтобы предложить свой вариант. Чем точнее твой промпт — тем выше шанс на победу! Внимание! Чтобы все играли честно, я не буду показывать процент схожести до конца рау
                                         "Удачи 🏆")
